...
class LoadUserData extends AbstractFixture implements OrderedFixtureInterface, ContainerAwareInterface {
    ...
    public function loadTeachers(ObjectManager $manager) {
        ...
        $arrays = array(
            'firstname' => 'salsa y passion',
            'firstname' => 'salsa loca',
            'firstname' => 'amor de salsa',
            'firstname' => 'los bailadores',
            'firstname' => 'Salsa de la calle',
            'firstname' => 'rythmes latins',
            'firstname' => 'sensualité et danse',
            'firstname' => 'africasalsa',
            'firstname' => 'dance & fun',
            'firstname' => 'bests salsa teachers',
            'firstname' => 'learn to dance',
            'firstname' => "latino's rythms",
        );
        ...
        foreach ($arrays as $value) {
            ...
            $this->addReference('user-teacher-' . $value, $User);
        }
        $manager->flush();
    }
    ...
    public function loadArtits(ObjectManager $manager) {
        ...
        foreach ($arrays as $value) {
            ...
            $this->addReference('user-artist-' . $value, $User);
        }
        $manager->flush();
    }
    ...
    public function loadBars(ObjectManager $manager) {
        ...
        foreach ($arrays as $value) {
            ...
            $this->addReference('user-bar-' . $value, $User);
        }
        $manager->flush();
    }
