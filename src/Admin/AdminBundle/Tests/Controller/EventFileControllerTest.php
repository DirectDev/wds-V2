...
class AddressControllerTest extends WebTestCase {
    ...
    public function testDelete() {
        ...
        $count_addresss_before = $this->em->getRepository('FrontFrontBundle:Address')->count();
        ...
        $count_addresss_after = $this->em->getRepository('FrontFrontBundle:Address')->count();
        ...
        $this->assertEquals(($count_addresss_before - 1), $count_addresss_after);
