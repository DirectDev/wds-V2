...
use Admin\AdminBundle\Form\EventDateFilterType;
...
class EventDateController extends Controller {
    ...
    public function indexAction(Request $request) {
        ...
        $query = $em->getRepository('FrontFrontBundle:EventDate')->findForAdmin($request->getLocale());
    ...
    private function createFilterForm() {
        $form = $this->createForm(new EventDateFilterType(), null, array(
            'action' => $this->generateUrl('admin_eventdate_filter'),
            'method' => 'GET',
        ));
    ...
    public function filterAction(Request $request) {
        ...
        $query = $em->getRepository('FrontFrontBundle:EventDate')->filterAdmin($filterData, $request->getLocale());
