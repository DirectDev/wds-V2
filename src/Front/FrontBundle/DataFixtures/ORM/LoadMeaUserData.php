...
class LoadMeaUserData extends AbstractFixture implements OrderedFixtureInterface {
    ...
    public function load(ObjectManager $manager) {
        ...
        $user_reference1 = $user_reference2 = $user_reference3 = null;
        for ($i = 0; $i <= 10; $i++) {

            if ($user_reference1 != $user_reference2 && $user_reference2 != $user_reference3 && $user_reference1 != $user_reference3)
                break;
