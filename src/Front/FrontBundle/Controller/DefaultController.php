...
//        }
        ...
        $events = $this->getEvents($em, true, $this->max_results, $eventTypes, $musicTypes, $startdate, $tomorrow, $city->getLatitude(), $city->getLongitude());
        $nextEvents = $this->getEvents($em, false, $this->max_results, $eventTypes, $musicTypes, $tomorrow, $stopdate, $city->getLatitude(), $city->getLongitude(), null, $events);
